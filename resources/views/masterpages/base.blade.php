...
<head>
	...
	<link rel="stylesheet" href="{{asset('static/css/mstyle.css')}}"> <!-- Resource style -->
...
<body>
	...
	<header class="cd-main-header">
		<a class="cd-logo" href="#0"><img src="{{asset('img/cd-logo.svg')}}" alt="Logo"></a>

		<ul class="cd-header-buttons align-right">
			<li><a  href="#cd-search">rs<span></span></a></li>
		...
		<div class="content-wrap">
            <div class="content">
                    ...
                    <div class="container">
                        ...
                        <div class="wrap-hero-content">
                            <div class="hero-content">
                                <h1>Bienvenue sur le site du Lycée Moderne Jeunes Filles de Bouaké</h1>
                                <br>
                ...
                <!--/.HOME END-->
                            ...
                            <!--SERVICES-->
                    <section class="white-bg mar-tm-10" id="services">
                        <div class="container">
                            <div class="row">
                            <div class="col-md-3">
                                <h3 class="title-small">
                                    <span>Mots de bienvenu du Proviseur</span>
                                </h3>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-9 content-right">
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-1.png"><img alt="image" src="{{asset('static/images/bw-1.png')}}">
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-2.png"><img alt="image" src="{{asset('static/images/bw-2.png')}}">
                                        <div class="decription-wrap">
                                            <div class="image-bg">
                                            <p class="desc">
                                                Salle informatique
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-3.png"><img alt="image" src="{{asset('static/images/bw-3.png')}}">
                                        <div class="decription-wrap">
                                            <div class="image-bg">
                                            <p class="desc">
                                                Black Mug
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-4.png"><img alt="image" src="{{asset('static/images/bw-4.png')}}">
                                        <div class="decription-wrap">
                                            <div class="image-bg">
                                            <p class="desc">
                                                Notebook Mockup
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-5.png"><img alt="image" src="{{asset('static/images/bw-5.png')}}">
                                        <div class="decription-wrap">
                                            <div class="image-bg">
                                            <p class="desc">
                                                Complexe sportif
                                    ...
                                    <li class="col-md-6">
                                        <a href="images/bw-6.png"><img alt="image" src="{{asset('static/images/bw-6.png')}}">
                                        <div class="decription-wrap">
                                            <div class="image-bg">
                                            <p class="desc">
                                                Cantine scolaire
...
{{-- 
	...
	<nav class="cd-nav">
		<ul id="cd-primary-nav" class="cd-primary-nav">
            ...
            {{-- <li><a href="#">Espace de Travail</a></li> --}}
...
{{-- <script src="{{asset('static/js/bmain.js')}}"></script> <!-- Resource jQuery --> --}}
<script src="{{asset('static/js/main.js')}}"></script> <!-- Resource jQuery -->
</body>
</html>