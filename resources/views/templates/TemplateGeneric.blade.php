                    ...
                    <ul class="nav navbar-nav">
                        <li class="has-child"><a href="#" title="Основное личное меню пользователя"><i class="fa fa-user fa-fw"></i>&nbsp;Личный кабинет</a>
                            <ul class="child-navigation">
                              <li><a href="#" title="Проверить новые сообщения, вам должно повезти" class="list-group-item"><i class="fa fa-envelope-o"></i>&nbsp; Сообщения мне &nbsp;<span class="label label-danger pull-right">14</span></a></li> <!-- CZ кол-во сообщений выводится из базы -->
								                <li><a href="#" title="Проверить и добавить новое объявление"><i class="fa fa-th-list"></i>&nbsp; Мои объявления</a></li>
								                <li><a href="#" title="Настройки пользователя и сайта"><i class="fa fa-cogs"></i>&nbsp; Настройки</a>
            ...
            <div class="col-md-3 col-sm-2">
                <section id="sidebar">
                    ...
                    <aside>
                        ...
                        <style>
                        ol {
                          list-style-type: none; /* ДОБАВИТЬ В CSS СТИЛЬ НУМЕРОВАННОГО СПИСКА */
                        }
                        </style>
                          <li class=""><a href="mailbox.html"><i class="fa fa-envelope-o"></i><span>Сообщения</span></a></li>
                          <li><a href="my-properties.html"><i class="fa fa-newspaper-o" aria-hidden="true"></i><span>Объявления</span></a>
                            <ol>
                              <li><a href="my-properties.html"><i class="fa fa-newspaper-o" aria-hidden="true"></i><span>Мои объявления</span></a>
                              <li class="active"><a href="bookmarked.html"><i class="fa fa-heart-o"></i><span>Избранное</span></a></li>
                              <li><a href="bookmarked-list.html"><i class="fa fa-list-ul" aria-hidden="true"></i></i><span>Избранное список</span></a></li>
                            </ol>
                          </li>
                          <li><a href="profile.html"><i class="fa fa-cogs"></i><span>Настройки</span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
            <!-- end Sidebar -->
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="bookmarked-properties">
                        <header><h1>Избранные объявления</h1></header>
                        <div class="grid">
                            ...
                            <div class="inner">
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        <div class="overlay">
                                            <div class="info">
                                                <div class="tag price">8 500 000</div>
                                            </div>
                                        </div>
                                ...
                                <aside>
                                    <header>
                                        <a href="property-detail.html"><h3>2х м.Шоссе Энтузиастов</h3></a>
                                        <figure>ул.Шоссе Энтузиастов, 147</figure>
                                    </header>
                                    <dl>
                                        <dt>Статус:</dt>
                                        <dd><strong>Обмен продажа</strong></dd>
                                        <dt>Общая площадь:</dt>
                                        <dd>86 м<sup>2</sup></dd>
                                        <dt>Жилая:</dt>
									...
									<div class="actions">
                                    <a href="#" class="link-arrow">удалить</a>
									</div>
                                </aside>
                            </div>
                        </div><!-- /.property -->
                            ...
                            <div class="inner" data-scroll-reveal>
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        <div class="overlay">
                                            <div class="info">
                                                <div class="tag price">6 000 000</div>
                                            </div>
                                        </div>
                                ...
                                <aside>
									...
									<div class="actions">
                                    <p><a href="#" class="link-arrow">удалить</a></p>
									</div>
                                </aside>
                            </div>
                        </div><!-- /.property -->
                            ...
                            <div class="inner" data-scroll-reveal>
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        <div class="">
                                            <div class="info">
                                                <div class="tag price">3 600 000</div>
                                            </div>
                                        </div>
